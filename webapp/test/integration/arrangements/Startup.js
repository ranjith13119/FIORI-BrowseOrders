sap.ui.define([
	"sap/ui/test/Opa5",
	"EvolvedWebApp/SplitAppCloudTraining/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("EvolvedWebApp.SplitAppCloudTraining.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "EvolvedWebApp.SplitAppCloudTraining",
					async: true
				},
				hash: oOptions.hash,
